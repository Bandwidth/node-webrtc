...
describe('api', () => {
    ...
    it('should generate transfer bxml', () => {
        ...
        var expectedString = '<?xmlversion="1.0"encoding="UTF-8"?><Response><Transfer><SipUri>uui="93d6f3c0be5845960b744fa28015d8ede84bd1a4;encoding=base64,test-string;encoding=jwt">sip:sipx.webrtc.bandwidth.com:5060</SipUri></Transfer></Response>';
